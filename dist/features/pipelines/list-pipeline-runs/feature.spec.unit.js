...
describe('listPipelineRuns unit', () => {
    ...
    beforeEach(() => {
        ...
        mockPipelinesApi = {
            ...
            formatResponse: jest.fn().mockImplementation((result) => {
                if (!result) {
                    return [];
                }
                return result.value ?? [];
    ...
    it('returns runs with continuation token from headers', async () => {
        ...
        const result = await (0, feature_1.listPipelineRuns)(mockConnection, {
    ...
    it('applies filters, pagination, and branch normalization', async () => {
        ...
        await (0, feature_1.listPipelineRuns)(mockConnection, {
            projectId: 'test-project',
            pipelineId: 42,
            top: 20,
    ...
    it('throws resource not found when API returns 404', async () => {
        ...
        await expect((0, feature_1.listPipelineRuns)(mockConnection, {
            projectId: 'test-project',
            pipelineId: 999,
