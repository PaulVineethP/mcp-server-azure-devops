...
describe('getRepositoryDetails unit', () => {
    ...
    test('should return basic repository information when no additional options are specified', async () => {
        ...
        // Act
        const result = await (0, feature_1.getRepositoryDetails)(mockConnection, {
    ...
    test('should pass refFilter to getRefs when provided', async () => {
        ...
        // Act
        await (0, feature_1.getRepositoryDetails)(mockConnection, {
            projectId: 'test-project',
            repositoryId: 'test-repo',
            includeRefs: true,
            refFilter: 'heads/',
        ...
        // Assert
        expect(getRefs).toHaveBeenCalledWith(mockRepository.id, 'test-project', 'heads/');
    });
    test('should pass branchName to getBranches when provided', async () => {
        ...
        // Assert
        expect(getBranches).toHaveBeenCalledWith(mockRepository.id, 'test-project', {
            version: 'main',
    ...
    test('should propagate resource not found errors', async () => {
        ...
        // Act & Assert
        await expect((0, feature_1.getRepositoryDetails)(mockConnection, {
            projectId: 'test-project',
        ...
        await expect((0, feature_1.getRepositoryDetails)(mockConnection, {
            projectId: 'test-project',
            repositoryId: 'non-existent-repo',
        })).rejects.toThrow("Repository 'non-existent-repo' not found in project 'test-project'");
    });
