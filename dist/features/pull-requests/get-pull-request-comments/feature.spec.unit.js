...
describe('getPullRequestComments', () => {
    ...
    test('should return pull request comment threads with file path and line number', async () => {
        ...
        const result = await (0, feature_1.getPullRequestComments)(mockConnection, projectId, repositoryId, pullRequestId, options);
        // Verify results
        ...
        expect(mockGitApi.getThreads).toHaveBeenCalledWith(repositoryId, pullRequestId, projectId, undefined, undefined);
    ...
    test('should handle comments without thread context', async () => {
        ...
        const result = await (0, feature_1.getPullRequestComments)(mockConnection, 'test-project', 'test-repo', 123, {
    ...
    test('should return a specific comment thread when threadId is provided', async () => {
        ...
        expect(mockGitApi.getPullRequestThread).toHaveBeenCalledWith(repositoryId, pullRequestId, threadId, projectId);
    ...
    test('should handle error when API call fails', async () => {
        ...
        await expect((0, feature_1.getPullRequestComments)(mockConnection, projectId, repositoryId, pullRequestId, options)).rejects.toThrow(`Failed to get pull request comments: ${errorMessage}`);
    });
});
