...
const feature_3 = require("../../work-items/list-work-items/feature");
...
describeOrSkip('updatePullRequest integration', () => {
    ...
    beforeAll(async () => {
        ...
        const workItems = await (0, feature_3.listWorkItems)(connection, {
        ...
        const testPullRequest = await (0, feature_2.createPullRequest)(connection, projectName, repositoryId, {
            title: uniqueTitle,
    ...
    test('should add work item links to pull request', async () => {
        ...
        const workItemRefs = await gitApi.getPullRequestWorkItemRefs(repositoryId, pullRequestId, projectName);
