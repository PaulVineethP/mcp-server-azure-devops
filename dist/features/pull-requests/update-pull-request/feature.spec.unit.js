...
describe('updatePullRequest', () => {
    ...
    beforeEach(() => {
        jest.clearAllMocks();
        client_factory_1.AzureDevOpsClient.mockImplementation(() => mockAzureDevopsClient);
    ...
    it('should throw error when pull request does not exist', async () => {
        ...
        await expect((0, feature_1.updatePullRequest)({
            projectId: 'project-1',
            repositoryId: 'repo1',
            pullRequestId: 123,
    ...
    it('should add new tags to the pull request', async () => {
        ...
        mockCreatePullRequestLabel.mockImplementation(async (label) => ({
            name: label.name,
        }));
        const result = await (0, feature_1.updatePullRequest)({
            projectId: 'project-1',
        ...
        expect(mockGetPullRequestLabels).toHaveBeenCalledWith('repo1', 123, 'project-1');
        expect(mockCreatePullRequestLabel).toHaveBeenCalledTimes(2);
        expect(mockCreatePullRequestLabel).toHaveBeenCalledWith({ name: 'New Tag' }, 'repo1', 123, 'project-1');
        expect(mockCreatePullRequestLabel).toHaveBeenCalledWith({ name: 'Another' }, 'repo1', 123, 'project-1');
    ...
    it('should remove tags and ignore missing ones', async () => {
        ...
        expect(mockDeletePullRequestLabels).toHaveBeenCalledWith('repo1', 123, 'remove', 'project-1');
        expect(mockDeletePullRequestLabels).toHaveBeenCalledWith('repo1', 123, 'missing', 'project-1');
