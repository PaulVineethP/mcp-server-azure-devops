...
describeOrSkip('addPullRequestComment integration', () => {
    ...
    beforeAll(async () => {
        ...
        const pr = await (0, feature_2.createPullRequest)(connection, projectName, repositoryId, {
    ...
    test('should add a new comment thread to pull request', async () => {
        ...
        const result = await (0, feature_1.addPullRequestComment)(connection, projectName, repositoryId, pullRequestId, {
    ...
    test('should add a reply to an existing comment thread', async () => {
        const initialComment = await (0, feature_1.addPullRequestComment)(connection, projectName, repositoryId, pullRequestId, {
            projectId: projectName,
            repositoryId,
            pullRequestId,
