 ...
 */
async function createWorkItem(connection, projectId, workItemType, options) {
    try {
        if (!options.title) {
        ...
        const workItem = await witApi.createWorkItem(null, document, projectId, workItemType);
        if (!workItem) {
