...
class WikiClient {
    baseUrl;
    constructor(options) {
        const fallbackOrg = options.organizationId || environment_1.defaultOrg;
        const organizationUrl = options.organizationUrl ??
            process.env.AZURE_DEVOPS_ORG_URL ??
            `https://dev.azure.com/${fallbackOrg}`;
        const baseUrls = (0, azure_devops_url_1.resolveAzureDevOpsBaseUrls)(organizationUrl, {
