...
describeOrSkip('updateWorkItem integration', () => {
    ...
    test('should update a work item title in Azure DevOps', async () => {
        ...
        const result = await (0, feature_1.updateWorkItem)(connection, createdWorkItemId, options);
    ...
    test('should update multiple fields at once', async () => {
        const newDescription = 'This is an updated description from integration tests';
        const newPriority = 1;
        const options = {
    ...
    test('should throw error when updating non-existent work item', async () => {
        ...
        await expect((0, feature_1.updateWorkItem)(connection, nonExistentId, options)).rejects.toThrow(/Failed to update work item|not found/);
    });
});
