...
describe('manageWorkItemLink', () => {
    ...
    test('should add a work item link', async () => {
        ...
        // Execute
        const result = await (0, feature_1.manageWorkItemLink)(mockConnection, projectId, {
            sourceWorkItemId,
            targetWorkItemId,
            operation: 'add',
            relationType,
        ...
        expect(mockWitApi.updateWorkItem).toHaveBeenCalledWith({}, // customHeaders
        [
            {
                op: 'add',
                path: '/relations/-',
    ...
    test('should throw error when work item not found', async () => {
        ...
        // Execute and verify
        await expect((0, feature_1.manageWorkItemLink)(mockConnection, projectId, {
            sourceWorkItemId,
            targetWorkItemId,
            operation: 'add',
            relationType,
